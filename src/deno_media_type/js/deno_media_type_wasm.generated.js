...
/// <reference types="./deno_media_type_wasm.generated.d.ts" />

// source-hash: 96113cdf1cc074bd192bc219087b8d2137332d86
let wasm;
 ...
 * @returns {string}
 */
export function fromSpecifier(url) {
  let deferred2_0;
  let deferred2_1;
  try {
    ...
    wasm.fromSpecifier(retptr, ptr0, len0);
...
export async function instantiateWithInstance(opts) {
  const { instance } = await loader.load(
    opts?.url ?? new URL("deno_media_type_wasm_bg.wasm", import.meta.url),
    opts?.decompress,
  );
